...
import ScrollToothPlayer from '../ScrollToothPlayer';
                ...
                <header className=" w-screen h-20 flex justify-center md:pt-10 pb-6 md:pb-8 px-8 md:px-16 lg:px-24 z-10">
                    <div className="max-w-6xl mx-auto flex items-center justify-between gap-80">
                        ...
                        <nav className="flex items-center gap-6 md:gap-10">
                            ...
                            <button className="px-4 py-2 rounded-full bg-[#FE4900] hover:bg-[#FE4900]/80 cursor-pointer transition backdrop-blur-md text-white text-sm font-medium border border-white/30 transition-all">
                                Book a visit
                            </button>
                        </nav>
                    </div>
